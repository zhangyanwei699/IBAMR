...
void
IBFESurfaceMethod::backwardEulerStep(const double current_time, const double new_time)
{
    const double dt = new_time - current_time;
    int ierr;
    for (unsigned int part = 0; part < d_num_parts; ++part)
...
void
IBFESurfaceMethod::createSolutionVec(Vec* X_vec)
{
...
void
IBFESurfaceMethod::createSolverVecs(Vec* X_vec, Vec* R_vec)
{
    // TODO: Don't rebuild these vectors each time.
    d_implicit_X_vecs.clear();
...
void
IBFESurfaceMethod::setupSolverVecs(Vec& X_vec, Vec& R_vec)
{
    PetscErrorCode ierr;
    PetscInt N;
...
void
IBFESurfaceMethod::setUpdatedPosition(Vec& X_new_vec)
{
    PetscErrorCode ierr;
    PetscInt N;
    Vec* X_new_sub_vecs;
...
void
IBFESurfaceMethod::getUpdatedPosition(Vec& X_new_vec)
{
    PetscErrorCode ierr;
    PetscInt N;
    Vec* X_new_sub_vecs;
...
void
IBFESurfaceMethod::computeResidualBackwardEuler(Vec& R_vec)
{
    PetscErrorCode ierr;
    PetscInt N;
    Vec* R_sub_vecs;
...
void
IBFESurfaceMethod::computeResidualMidpointRule(Vec& R_vec)
{
    PetscErrorCode ierr;
    PetscInt N;
    Vec* R_sub_vecs;
...
void
IBFESurfaceMethod::computeResidualTrapezoidalRule(Vec& R_vec)
{
    PetscErrorCode ierr;
    PetscInt N;
    Vec* R_sub_vecs;
